...
-- XXXXXXXXXXXXXXXXXXXXXXXXXX
SELECT CONCAT('Low Water Intake Trigger (below 1.5 liters)' ) as Triggers, SUM(tablle2.NumberWaterIntakeTriggerValue ) as NumberofTriggers, tablle4.NumberOfMigraines as NumberOfMigraines,  ROUND(((SUM(tablle2.NumberWaterIntakeTriggerValue ) / tablle4.NumberOfMigraines) * 100),0) as Percentage
FROM
