...
-- XXXXXXXXXXXXXXXXXXXXXXXXXX
SELECT CONCAT('Not enough water intake (below 1.5 liters)' ) as WaterTrigger, SUM(tablle2.NumberWaterIntakeTriggerValue ) as NumberofWaterTrigger, tablle4.NumberOfMigraines as NumberOfMigraines,  ROUND(((SUM(tablle2.NumberWaterIntakeTriggerValue ) / tablle4.NumberOfMigraines) * 100),0) as Percentage
FROM
